...
- 前提課題：<完成を前提とする他のエンハンス課題。通常は「なし」。判定基準は本課題の**受入条件**が他課題の成果物の存在を前提とするかどうかで、単なる作業順序の好みは「推奨着手順序」に書く>
- 競合する課題：<同一ファイル・テーブル・エンドポイント・マイグレーションを変更する課題と、その共有成果物名。並行着手は非推奨である旨を添える。なければ「なし」>
- 推奨着手順序：<前提課題ほど強くはないが、先行・後続が望ましい課題とその理由。なければ「特になし」>
...
- 推定工数：<数時間 / 半日 / 1日 / 1〜2日 / 2〜3日。学習者が着手してからセルフマージするまでの純粋な作業時間（初回のみのツール習熟コストの小バッファを含む。承認待ちは発生しない）で見積もる>
