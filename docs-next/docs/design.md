...
[ショーケースを全画面で開く](../design/preview.html) ・ [DESIGN.md 原文（GitHub）](https://github.com/CHS-Training-Org/ai_training_for_chuo_system/blob/main/DESIGN.md)
...
<div class="ds-block ds-hero">
  ...
  <div class="hero-buttons">
    <a class="btn btn-primary btn-md" href="https://github.com/CHS-Training-Org/ai_training_for_chuo_system/blob/main/DESIGN.md" rel="noopener">DESIGN.md を読む</a>
    <a class="btn btn-outline btn-md" href="./design/preview.html" rel="noopener">全画面で開く</a>
  </div>
</div>
