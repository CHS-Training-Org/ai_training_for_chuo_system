...
- [ ] Generate `Docs/spec/aidlc-docs/inception/application-design/unit-of-work.md` with unit definitions and responsibilities
- [ ] Generate `Docs/spec/aidlc-docs/inception/application-design/unit-of-work-dependency.md` with dependency matrix
- [ ] Generate `Docs/spec/aidlc-docs/inception/application-design/unit-of-work-story-map.md` mapping stories to units
...
- Save as `Docs/spec/aidlc-docs/inception/plans/unit-of-work-plan.md`
...
- Ask: "**Unit of work plan complete. Review the plan in Docs/spec/aidlc-docs/inception/plans/unit-of-work-plan.md. Ready to proceed to generation?**"
...
- [ ] Read the complete plan from `Docs/spec/aidlc-docs/inception/plans/unit-of-work-plan.md`
...
- [ ] Update `Docs/spec/aidlc-state.md` current status
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the units generation artifacts at: `Docs/spec/aidlc-docs/inception/application-design/`
...
- Mark Units Generation stage complete in `Docs/spec/aidlc-state.md`
- Update the "Current Status" section
