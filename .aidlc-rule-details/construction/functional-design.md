...
- Read unit definition from `Docs/spec/aidlc-docs/inception/application-design/unit-of-work.md`
- Read assigned stories from `Docs/spec/aidlc-docs/inception/application-design/unit-of-work-story-map.md`
...
### Step 4: Store Plan
- Save as `Docs/spec/aidlc-docs/construction/plans/{unit-name}-functional-design-plan.md`
...
- Create `Docs/spec/aidlc-docs/construction/{unit-name}/functional-design/business-logic-model.md`
- Create `Docs/spec/aidlc-docs/construction/{unit-name}/functional-design/business-rules.md`
- Create `Docs/spec/aidlc-docs/construction/{unit-name}/functional-design/domain-entities.md`
- If unit includes frontend/UI: Create `Docs/spec/aidlc-docs/construction/{unit-name}/functional-design/frontend-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the functional design artifacts at: `Docs/spec/aidlc-docs/construction/[unit-name]/functional-design/`
