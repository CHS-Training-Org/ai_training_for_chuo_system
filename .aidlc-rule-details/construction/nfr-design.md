...
- Read NFR requirements from `Docs/spec/aidlc-docs/construction/{unit-name}/nfr-requirements/`
...
### Step 4: Store Plan
- Save as `Docs/spec/aidlc-docs/construction/plans/{unit-name}-nfr-design-plan.md`
...
- Create `Docs/spec/aidlc-docs/construction/{unit-name}/nfr-design/nfr-design-patterns.md`
- Create `Docs/spec/aidlc-docs/construction/{unit-name}/nfr-design/logical-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR design at: `Docs/spec/aidlc-docs/construction/[unit-name]/nfr-design/`
