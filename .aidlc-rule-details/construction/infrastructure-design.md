...
- Read functional design from `Docs/spec/aidlc-docs/construction/{unit-name}/functional-design/`
- Read NFR design from `Docs/spec/aidlc-docs/construction/{unit-name}/nfr-design/` (if exists)
...
### Step 4: Store Plan
- Save as `Docs/spec/aidlc-docs/construction/plans/{unit-name}-infrastructure-design-plan.md`
...
- Create `Docs/spec/aidlc-docs/construction/{unit-name}/infrastructure-design/infrastructure-design.md`
- Create `Docs/spec/aidlc-docs/construction/{unit-name}/infrastructure-design/deployment-architecture.md`
- If shared infrastructure: Create `Docs/spec/aidlc-docs/construction/shared-infrastructure.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the infrastructure design at: `Docs/spec/aidlc-docs/construction/[unit-name]/infrastructure-design/`
