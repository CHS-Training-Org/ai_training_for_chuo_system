...
- [ ] Read workspace root and project type from `Docs/spec/aidlc-state.md`
...
- [ ] Document exact paths (never Docs/spec/aidlc-docs/)
...
- [ ] Save complete plan as `Docs/spec/aidlc-docs/construction/plans/{unit-name}-code-generation-plan.md`
...
- [ ] Before asking for approval, log the prompt with timestamp in `Docs/spec/aidlc-audit.md`
...
- [ ] Read the complete plan from `Docs/spec/aidlc-docs/construction/plans/{unit-name}-code-generation-plan.md`
- [ ] Identify the next uncompleted step (first [ ] checkbox)
- [ ] Load the context for that step (unit, dependencies, stories)

## Step 11: Execute Current Step
- [ ] Verify target directory from plan (never Docs/spec/aidlc-docs/)
...
- [ ] Write to correct locations:
  ...
  - **Documentation**: `Docs/spec/aidlc-docs/construction/{unit-name}/code/` (markdown only)
...
> - **Documentation**: `Docs/spec/aidlc-docs/construction/[unit-name]/code/`
...
### Code Location Rules
- **Application code: Workspace root only (NEVER Docs/spec/aidlc-docs/))
- **Documentation**: Docs/spec/aidlc-docs/ only (markdown summaries)
